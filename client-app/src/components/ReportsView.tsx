...
export function ReportsView({ theme, fetchWithAuth }: ReportsViewProps) {
    ...
    const handleGenerateReport = async () => {
        ...
        try {
          ...
          const endpoint = reportType === 'violations'
            ? '/api/reports/violations?' + query
          ...
          if (reportFormat === 'json') {
            downloadFile(JSON.stringify(normalizedRows, null, 2), `${filenameBase}.json`, 'application/json;charset=utf-8');
          } else {
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                >
                  ...
                  <option value="violations">Нарушения графика и замен</option>
                </select>
              </div>
              <div>
