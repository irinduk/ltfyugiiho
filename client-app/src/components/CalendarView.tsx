...
export function CalendarView({
    ...
    const getDayShifts = (date: string) => {
        ...
        let filtered = shifts.filter(s => {
            // Исправлено: сравниваем даты корректно, учитывая разные форматы
    ...
    const handleVacationStartChange = (value: string) => {
        ...
        // Если окончание не выбрано или раньше начала — ставим окончание в ту же дату.
    ...
    const leaveTypeRu = (value?: string) => {
        switch (value) {
            ...
            case 'Unpaid': return 'Без содержания';
